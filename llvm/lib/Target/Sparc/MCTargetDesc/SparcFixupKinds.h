...
namespace llvm {
  namespace Sparc {
    enum Fixups {
      ...
      /// fixup_sparc_got32 - 32-bit fixup corresponding to %got32(foo)
      fixup_sparc_got32,
